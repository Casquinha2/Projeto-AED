...
#        messagebox.askquestion('', 'O utilizador ainda não definiu um orçamento mensal. Deseja definir?')
    ...
    def registo_despesas(self):
        ...
        #valor de despesa
        self.valor_despesas_label = tk.Label(self.frame2, text="Valor da despesa: ", font=('Arial', 14), bg='#CF0000')
        ...
        #data de despesa
        self.data_despesas_label = tk.Label(self.frame2, text="Data da despesa: ", font=('Arial', 14), bg='#CF0000')
...
#        self.formato1 = self.data.strftime("%d/%m/%Y")
        ...
        self.categoria_despesas_label = tk.Label(self.frame2, text="Categoria da despesa: ", font=('Arial', 14), bg='#CF0000')
        ...
        self.descrição_despesas_label = tk.Label(self.frame2, text="Descrição da despesa (Almoço em restaurante): ", font=('Arial', 14), bg='#CF0000')
    ...
    def frame_registar(self):        
        ...
        #Label + Entry para username
        self.nome_label = tk.Label(self.frame3, text="Nome:", font=('Arial', 14), bg='#C90000')
        self.nome_label.pack()
        self.nome_entry = tk.Entry(self.frame3, font=('Arial', 14))
        self.nome_entry.pack(pady=5)

        self.nif_label = tk.Label(self.frame3, text="NIF:", font=('Arial', 14), bg='#C90000')
        self.nif_label.pack()
        self.nif_entry = tk.Entry(self.frame3, font=('Arial', 14))
        self.nif_entry.pack(pady=5)     

        #Label + Entry para password
        self.password_label = tk.Label(self.frame3, text="Password:", font=('Arial', 14), bg='#C90000')
        self.password_label.pack()
        self.password_entry = tk.Entry(self.frame3, show="*", font=('Arial', 14))
        self.password_entry.pack(pady=5)

        #Botão de registo
        self.registo_button = tk.Button(self.frame3, text="Registo", font=('Arial', 14), fg='white', bg='#6d7575', command=self.registar)
        self.registo_button.pack(pady=10, ipadx=20, ipady=5)
